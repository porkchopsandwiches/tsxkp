module TSXKP {
    export module Dictionaries {
        export module Loaders {
            export class SampleLoader implements ILoader {
                public loaded: boolean = true;

                private words: string[] = ["Africa",
                    "Alabama",
                    "Alaska",
                    "America",
                    "Amsterdam",
                ...
                private cache: TSXKP.Dictionaries.IDictionary;

                constructor (config: TSXKP.Configs.IConfig) {
                    this.config = config;
                }

                public load (callback: ILoaderCallback): SampleLoader {
                    var words: string[];
                    var i: number;
                    var l: number;
